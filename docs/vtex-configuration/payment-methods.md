...
2. **Add Payment Conditions**: Click the ![**Add Payment Method**](/img/vtex-add-payment-method-button.png) button at the top right corner of the page to add a new Payment Condition.
3. **Set Payment Provider that will process the Conditions**: Configure the payment condition selecting the [Provider created in the previous step](configuring-provider) ![provider selection](/img/vtex-provider-selection.png).
